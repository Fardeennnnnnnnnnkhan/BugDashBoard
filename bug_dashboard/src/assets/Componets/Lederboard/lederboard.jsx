...
import { Trophy, Search, Medal, Zap, Target } from "lucide-react";
...
export default function Leaderboard() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      const sampleData = [
        { id: 1, name: "Mrinal", tasksCompleted: 47, performance: 98, reputation: 4875 },
        { id: 2, name: "Aniket", tasksCompleted: 42, performance: 95, reputation: 4210 },
        { id: 3, name: "Swapnil", tasksCompleted: 39, performance: 94, reputation: 3950 },
        { id: 4, name: "Shruti", tasksCompleted: 36, performance: 92, reputation: 3650 },
        { id: 5, name: "Janvi", tasksCompleted: 33, performance: 90, reputation: 3320 },
        { id: 6, name: "Rohit Sharama", tasksCompleted: 31, performance: 88, reputation: 3100 },
        { id: 7, name: "virat kholi", tasksCompleted: 29, performance: 87, reputation: 2780 },
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gray-900/50 text-gray-400 border-b-2 border-gray-700">
                  ...
                  <th className="px-6 py-4 text-left text-sm font-semibold">Champion</th>
                  <th className="px-6 py-4 text-center text-sm font-semibold">Quests</th>
                  <th className="px-6 py-4 text-center text-sm font-semibold">Power</th>
                  <th className="px-6 py-4 text-right text-sm font-semibold">Glory Points</th>
                </tr>
              </thead>
              <tbody>
