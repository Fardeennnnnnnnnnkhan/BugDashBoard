...
// //   // Handle form submission to add a new script
// //   const handleAddNewScript = async () => {
// //     console.log("Add New Script button clicked. Current data:", newScript);
...
// //     // Map local field names to backend field names
// //     const scriptData = {
// //       activity: newScript.name,
// //       category: newScript.category,
// //       tools_technique: newScript.code,
// //     };
...
//         console.log("Fetched scripts:", response.data); // For debugging
...
//   // Filter the scripts based on search term
//   const filteredScripts = dbScripts.filter((script) => {
//     return (
//       script.category.toLowerCase().includes(searchTerm.toLowerCase()) ||
//       script.activity.toLowerCase().includes(searchTerm.toLowerCase())
//     );
//   });

//   return (
//     <div className="max-w-6xl mx-auto p-4">
//       <h2 className="text-xl font-semibold mb-4">Fetched Testing Scripts</h2>
//       <div className="border rounded-lg">
//         <button
//           className="w-full p-3 flex items-center justify-between hover:bg-gray-50"
...
//   // State for fetched scripts
//   const [dbScripts, setDbScripts] = useState([]);
//   const [isDropdownOpen, setIsDropdownOpen] = useState(false);
//   const [searchTerm, setSearchTerm] = useState("");

//   // Fetch scripts from the backend on component mount and after adding new script
//   const fetchScripts = async () => {
//     try {
//       const response = await axios.get("http://localhost:3000/api/scripts");
...
//   // Handle submission of the new script form
//   const handleAddNewScript = async () => {
//     console.log("Add New Script button clicked. Current data:", newScript);
//     // Basic validation
//     if (!newScript.name || !newScript.category || !newScript.code) {
...
//       return;
//     }
//     // Map local field names to backend expected fields
//     const scriptData = {
//       activity: newScript.name,
//       category: newScript.category,
//       tools_technique: newScript.code,
...
//   // Filter fetched scripts based on search term
//   const filteredScripts = dbScripts.filter((script) => {
//     const category = script.category || "";
//     const activity = script.activity || "";
//     const search = searchTerm.toLowerCase();
//     return category.toLowerCase().includes(search) || activity.toLowerCase().includes(search);
//   });
...
//       {/* New Script Form */}
//       <div>
//         <h3 className="font-medium text-xl mb-4">Add New Script</h3>
//         <div className="space-y-4">
//           <input
//             type="text"
//             name="name"
