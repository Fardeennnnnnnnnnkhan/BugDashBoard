...
const { createTask, getAllTasks, updateTask, deleteTask ,getAccordingToStatus,updateTaskStatus } = require("../controllers/taskController");
...
router.get("/statusFetch", getAccordingToStatus);   
